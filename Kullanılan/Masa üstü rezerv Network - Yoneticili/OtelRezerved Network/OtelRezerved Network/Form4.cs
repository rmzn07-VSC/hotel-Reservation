...
namespace OtelRezerved_Network
{
    ...
    public partial class rezervsayfa_Form : Form
    {
        ...
        private uygulama_ana_Form anaForm;

        public rezervsayfa_Form(uygulama_ana_Form anaForm)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (OleDbConnection conn = new OleDbConnection(connString))
            {
                ...
                using (OleDbCommand cmd = new OleDbCommand(query, conn))
                {
                    string yorum = rezervsayfa_kullaniciyorum_richTextBox.Text;

                    // Eğer yorum boş veya sadece boşluklardan oluşuyorsa, işlemi durdur
