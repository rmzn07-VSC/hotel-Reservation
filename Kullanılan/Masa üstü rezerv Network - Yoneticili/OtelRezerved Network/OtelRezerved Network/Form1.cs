...
namespace OtelRezerved_Network
{
    public partial class uygulama_ana_Form : Form
    {
        ...
        private void rezervtemizle()
        {
            uyg_oteladibilgi_label.Text = "";
            uyg_aciklamabilgi_richTextBox.Text = "";
            uyg_fiyatbilgi_label.Text = "";
            uyg_konumbilgi_label.Text = "";
            uyg_bolgekonumbilgi_label.Text = "";
            uyg_yildizbilgi_label.Text = "";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                goster_musteri_yorumm();
                goster_musteri_fav();
                oteladi_fav_textBox.Clear();
            }
        }

        private void uyg_yardimdestek_tabPage_Click(object sender, EventArgs e)
        {

        }

        private void uyg_son_panel_Paint(object sender, PaintEventArgs e)
        {
