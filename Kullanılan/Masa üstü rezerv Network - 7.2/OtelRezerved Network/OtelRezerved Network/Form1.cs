        ...
        private void uygulama_ana_Form_Load(object sender, EventArgs e)
        {
            ...
            using (OleDbConnection conn = new OleDbConnection(connStr))
            {
                ...
                while (reader.Read())
                {
                    ...
                    // giris_kayit_Form'un bir örneğini global olarak sakla
                    giris_kayit_Form girisForm = new giris_kayit_Form();
                    ...
                    rezerveSayfasiButton.Click += (s, args) =>
                    {
                        ...
                        if (s is Button button)
                        {
                            ...
                            if (groupBoxx != null)
                            {
                                ...
                                // giris_kayit_Form formundaki giris_email_textBox'tan e-posta adresini al

                                // giris_kayit_Form formundaki giris_email_textBox'tan e-posta adresini al
                                GlobalVariables.musteriAdiGlobal = girisForm.giris_email_textBox.Text;
                                string musteriAdi = GlobalVariables.musteriAdiGlobal;
