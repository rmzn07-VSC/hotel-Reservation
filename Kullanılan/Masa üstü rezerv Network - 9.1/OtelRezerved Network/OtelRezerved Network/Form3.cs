...
namespace OtelRezerved_Network
{
    public partial class yonetici_merkez_Form : Form
    {
        ...
        private void musteri_musterigöster_listView_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                kayit_email_textBox.Text = musteri_musterigöster_listView.SelectedItems[0].SubItems[1].Text.ToString();
                kayit_sifre_textBox.Text = musteri_musterigöster_listView.SelectedItems[0].SubItems[2].Text.ToString();
                kayit_telno_textBox.Text = musteri_musterigöster_listView.SelectedItems[0].SubItems[3].Text.ToString();
                kayit_konum_comboBox.Text = musteri_musterigöster_listView.SelectedItems[0].SubItems[4].Text.ToString();
