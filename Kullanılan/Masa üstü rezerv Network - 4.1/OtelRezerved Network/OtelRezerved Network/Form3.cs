...
{
    public partial class yonetici_merkez : Form
    {
        public yonetici_merkez()
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    + onecikan_oteladi_textBox.Text + "','" + onecikan_aciklama_TextBox.Text + "','" + onecikan_fiyat_textBox.Text +
                    "','" + onecikan_konum_comboBox1.Text + "','" + onecikan_bolgeselkonum_comboBox.Text + "','" + onecikan_yildizsayisi_textBox.Text + "','" + imagePath + "')", baglanti);
